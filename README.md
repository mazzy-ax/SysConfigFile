...
Вариант "без дополнительного расширения" позволяет программисту указать в наименовании конфига то имя файла, какое ему хочется,
и не парится о соглашениях.
...
Если методы не вызваны, то класс выполняет только [проверку синтаксиса](#Валидация-синтаксиса-config-файла) при чтении config-файла.
